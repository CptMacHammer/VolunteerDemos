...
function mousePressed(){
  ...
  switch (opt) {
    ...
    case 'circle':
      ...
      break;
    default:
      console.log('Sorry, we are out of dat shape' + '.');
  }
}
...
Particle.prototype.display = function () {
  ...
  var opt = sel.value();
  if(opt = "square"){
    rect(this.position.x, this.position.y, random(20), random(20));
  } else {
    ellipse(this.position.x, this.position.y, random(20), random(12));
  }
...
function mouseMoved(){
  fill(random(255),random(255),random(255),random(255));
  bezier(mouseX, mouseY, mouseX+random(10),mouseY+random(10),mouseX+random(50),mouseY+random(50), mouseX+random(100),mouseY+random(100));
}
